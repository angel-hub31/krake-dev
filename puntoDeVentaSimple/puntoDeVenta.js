calcularValorTotal = function () {
    ...
    */
    ...
    valorTotal = calcularTotal(valorIVA, valorDescuento, valorSubtotal);
    ...
    */
    let resumen = "valor a pagar por" + " " + cantidad + 
    " " + nombreProducto + " " + " con" + " " + porcentajeDescuento + "%" + 
    " de" + " descuento es:" + " " + "USD" + " " + valorTotal;
    mostrarTexto("lblMensaje", resumen);
