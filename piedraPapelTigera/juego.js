...
jugar = function (seleccionado) {
    ...
    cmpPartida.innerText = '';    // 5. **Actualización Inicial UI:** Limpia el mensaje de partida anterior y muestra la jugada del PC.
    if (cmpImgPc) cmpImgPc.src = imagen;
    if (ganador !== 0) {    // 6. **Procesar Resultado de la Partida:** Verifica si hubo un ganador (ganador != 0).
        if (ganador === 1) { // Gana el Jugador
            ...
            if (puntosJugador == 5) {            // **Verificación de Victoria Final (Juego):**
            ...
            if (puntosComputador == 5) {            // **Verificación de Victoria Final (Juego):**
